...
const socialLinks = [
  {
    path: "https://www.linkedin.com/in/priyanshuraj2005/",
    icon: <FaLinkedin className="w-5 h-5 group-hover:text-white" />,
  },
  {
    path: "https://www.instagram.com/priyanshu_agrawal08/",
    icon: <FaInstagram className="w-5 h-5 group-hover:text-white" />,
  },
  {
    path: "https://github.com/priyanshuraj20",
      ...
      <div className="container">
        <div className="flex justify-between flex-col sm:flex-row gap-8">
          <div>
            ...
            <p className="text-[15px] text-textColor font-[400] leading-7 mt-2 text-center">
              © {year} Built with <span className="text-red-500">❤</span> by{" "}
              <span className="font-[600] text-headingColor">Priyanshu</span>.
              All rights reserved.
            </p>
